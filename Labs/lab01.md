...
1. Sign in to **clXX-WS1** as **Admin** with the password of **Pa55w.rd**. **xx stands for User id**
...
7. On the **Sign in** page, type **`IntuneAdminXX@655vmg.onmicrosoft.com`** and then select **Next**.
...
1. On the **clXX-WS1** taskbar, select **Start**, type **cert**, and select **Manage computer certificates**.
...
1. Sign out of **clXX-WS1**.

2. Select **Other user**, and sign in as **`IntuneAdminXX@655vmg.onmicrosoft.com`** with the password **Pa55w.rd**. Wait for the profile to be created.
...
5. On the **Devices | Overview** blade, select **All devices** and verify that **clXX-WS1** is listed.
